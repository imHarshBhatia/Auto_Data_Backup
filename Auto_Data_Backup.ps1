...
try {
    $ErrorActionPreference = "Stop" #To make each occurring excpetion as Terminating. Error like (File not found)
    ...
    Write-CustomLog("Fatal Error: Execution failed due to:`n $exception")
}
finally {
$ErrorActionPreference = "Continue"
}